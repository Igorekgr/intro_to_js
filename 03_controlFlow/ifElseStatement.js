...
// console.log (`This is the largest number: ${numberOne}`)
// } else if( numberTwo > numberOne && numberTwo > numberThree){
//     console.log (`This is the largest number: ${numberTwo}`)
// } else {
//     console.log (`This is the largest number: ${numberThree}`)
// };
...
// Write a program based on given password and
// displays a message based on the password using an if-else statement:
